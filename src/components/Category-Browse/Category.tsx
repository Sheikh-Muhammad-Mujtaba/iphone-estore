    ...
    return (
        <div className="flex flex-col items-center py-[80px] gap-[32px] w-full min-h-[352px] bg-[#FAFAFA]">
            <div className="flex flex-row justify-between items-center p-0 w-[77.778vw] min-h-[32px]">
                ...
                <svg width="80" height="32" viewBox="0 0 80 32" fill="none" xmlns="http://www.w3.org/2000/svg" className='cursor-pointer'>
                    ...
                    <path d="M58.6667 4.33333C58.9322 4.33208 59.1869 4.43782 59.3734 4.62667L70.0401 15.2933C70.43 15.6838 70.43 16.3162 70.0401 16.7067L59.3734 27.3733C58.9794 27.7405 58.3654 27.7296 57.9846 27.3488C57.6038 26.968 57.5929 26.354 57.9601 25.96L67.9201 16L57.9601 6.04C57.5701 5.64958 57.5701 5.01709 57.9601 4.62667C58.1466 4.43782 58.4013 4.33208 58.6667 4.33333Z" fill="black" />
                </svg>
            </div>
            ...
            <div className="flex flex-row flex-wrap xl:flex-nowrap items-start justify-center p-0 gap-[32px] max-w-[1120px] min-h-[128px]">
                ...
                <div className='flex flex-col justify-center items-center px-[52px] py-[24px] gap-[8px] w-[160px] min-w-[135px] h-[128px] bg-[#EDEDED] rounded-[15px] cursor-pointer'>
                    ...
                    <h1 className="w-[58px] h-[24px] font-medium text-[16px] leading-[24px] text-center text-[#000000]">
                        Phones
                    </h1>
                </div>
                {/* smart watches */}
                <div className='flex flex-col justify-center items-center px-[52px] py-[24px] gap-[8px] w-[160px] min-w-[135px] h-[128px] bg-[#EDEDED] rounded-[15px] cursor-pointer'>
                    ...
                    <h1 className="w-[117px] h-[24px] font-medium text-[16px] leading-[24px] text-center text-[#000000]">
                        Smart Watches
                    </h1>
                </div>
                {/* Cameras */}
